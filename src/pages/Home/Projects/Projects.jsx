    ...
    return (
        <div className="holder mx-5 mt-16">
            <div className="container">
                <h1 className="title text-center"><span className='text-indigo-400'>My</span> Projects</h1>
                <p className='text-center'>I have completed these projects for learning purpose</p>
