...
const AddBlog = () => {
  ...
  <form onSubmit={handleSubmit} class="max-w-2xl mx-auto bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
    ...
    <div class="mb-6">
      <label class="block text-xs font-bold text-gray-700" for="description">
        Blog Description
      </label>
      <textarea
        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
